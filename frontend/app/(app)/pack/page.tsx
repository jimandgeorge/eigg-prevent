      ...
      <article className="space-y-8 print:text-black">
        ...
        <header className="border border-zinc-200 rounded-xl p-6 print:border-zinc-300">
          <div className="flex items-center gap-2 mb-4">
            <Logo size={22} className="text-ink shrink-0" />
            <span className="text-[13px] font-semibold tracking-tight text-zinc-900">EIGG Prevent</span>
          </div>
          ...
          <div className="flex items-center gap-8 mt-5 flex-wrap">
            ...
            <div className="space-y-1.5">
              ...
              <Meta k="Integrity" v={<span className="font-mono">SHA-256 · {pack.integrity_hash.slice(0, 12)}…</span>} />
            </div>
          </div>
        </header>
        ...
        <footer className="space-y-2 pt-2">
          <div className="rounded-lg bg-zinc-50 border border-zinc-200 px-4 py-3">
            <div className="text-[10px] font-semibold uppercase tracking-widest text-zinc-400 mb-1">Integrity hash (SHA-256)</div>
            <div className="font-mono text-[11px] text-zinc-700 break-all">{pack.integrity_hash}</div>
            <div className="text-[11px] text-zinc-400 mt-1.5">
              Computed over the complete pack at generation. Recompute it from this document to prove the
              record is unaltered.
            </div>
          </div>
